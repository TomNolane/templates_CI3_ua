...
<div class="row container3"><div class="col-md-12">
    <h2 class="text-center hh hh4"> Заявка с таким <span class="gold_font">номером телефона</span> уже существует.</h2>
    <h2 class="text-center hh hh4 grey" style="font-size: 19px;">Вы можете выбрать одно из подходящих Вам предложений. Отправив несколько заявок в разные банки, вы значительно увеличите свои шансы на получение займа.</h2>
    <br>
    <div class="row" id="for_google">
    
	 <div class="text-center" id="img_agree"><img src="/templates/common/img/stamp.png" alt="stamp.png"/></div>
