...
<head>
    ...
    <link rel="stylesheet" href="/templates/vamos/css/universal/<?=$universal_folder?>/tilda-grid-3.0.min.css" type="text/css" media="all">
    <link rel="stylesheet" href="/templates/vamos/css/universal/<?=$universal_folder?>/tilda-blocks-2.12.css" type="text/css" media="all">
    <link rel="stylesheet" href="/templates/vamos/css/universal/<?=$universal_folder?>/tilda-animation-1.0.min.css" type="text/css" media="all">
    <link rel="stylesheet" href="/templates/vamos/css/universal/<?=$universal_folder?>/tilda-slds-1.4.min.css" type="text/css" media="all">
    <link rel="stylesheet" href="/templates/vamos/css/universal/<?=$universal_folder?>/tilda-zoom-2.0.min.css" type="text/css" media="all">
    <link rel="stylesheet" type="text/css" href="/templates/vamos/css/universal/<?=$universal_folder?>/custom.css">
...
<body class="t-body" style="margin: 0px;">
    <header class="hidden" style="margin: 0 20px; top: 0; text-align: center">
        <a class="navbar-brand" href="/">
                <img src="/templates/vamos/img/universal/<?=$main?>_logo.png" class="t338__logo t-img">
            </a>
    <!-- <nav class="navbar">
    ...
    <div id="allrecords" class="t-records" data-hook="blocks-collection-content-node" data-tilda-project-id="663907"
        ...
        <div id="rec63469314" class="r t-rec t-screenmin-480px" style=" " data-animationappear="off" data-record-type="338"
            ...
            <!-- cover -->
            <div class="t-cover" id="recorddiv63469314" bgimgfield="img" style="height:100vh; background-image:url(&#39;/templates/vamos/img/universal/<?=$main?>_header.jpg&#39;);">
...
#rec63469314 .t-submit[data-btneffects-second] {	position: relative; overflow: hidden; -webkit-transform: translate3d(0,0,0); transform: translate3d(0,0,0);
        ...
        <div id="rec63581518" class="r t-rec t-screenmax-480px" style=" " data-animationappear="off" data-record-type="338"
            ...
            <!-- cover -->
            <div class="t-cover" id="recorddiv63581518" bgimgfield="img" style="height:100vh; background-image:url(&#39;/templates/vamos/img/universal/<?=$main?>_header.jpg&#39;);">
                ...
                <div class="t-section__container t-container">
                    <div class="t-col t-col_12">
                        <div class="t-section__topwrapper t-align_center">
                            <a href="<?=$link?>" target="_blank"> <img  class="t-img loaded"  style="width:100%; max-width:300px; text-aligh: center" src="/templates/vamos/img/universal/<?=$main?>_logo.png"></a>
                        </div>
                    </div>
                </div>
