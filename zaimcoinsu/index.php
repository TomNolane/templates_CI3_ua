                    ...
                    <div class="ex-adv-bg">
                        <div class="row">
                            <div class="col-md-4 ex-line-right ">
                                <div class="row ex-pad-not">
                                    <div class="ex-adv-block ex-line-bottom">
                                        <img src="/templates/zaimcoinsu/assets/img/icon1.png" alt="icon1.png">
                                        <p class="ex-og-text">3 450 000 гривен</p>
                                        <p>Общая сумма займов, уже выданная МФО
                                            через Zaimcoin. Деньги доступны в любой точке Украины
                            ...
                            <div class="col-md-4 ex-line-right ">
                                <div class="row">
                                    <div class="ex-adv-block ex-line-bottom">
                                        <img src="/templates/zaimcoinsu/assets/img/icon2.png" alt="icon2.png">
                            ...
                            <div class="col-md-4 ">
                                <div class="row ex-pad-not-right">
                                    <div class="ex-adv-block ex-line-bottom">
                                        <img src="/templates/zaimcoinsu/assets/img/icon3.png" alt="icon3.png">
                                        <p class="ex-og-text">10 000 гривен</p>
                            ...
                            <div class="col-md-4 ex-line-right">
                                <div class="row">
                                    <div class="ex-adv-block">
                                        <img src="/templates/zaimcoinsu/assets/img/icon4.png" alt="icon4.png">
                                        <p class="ex-og-text">3+3</p>
                                        <p>3 минуты уйдет у вас на заполнение анкеты,
                                            состоящей из 1 шага + 3 минуты на ожидание. Проще не бывает. </p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 ex-line-right">
                                <div class="row">
                                    <div class="ex-adv-block">
                                        <img src="/templates/zaimcoinsu/assets/img/icon5.png" alt="icon5.png">
                            ...
                            <div class="col-md-4">
                                <div class="row">
                                    <div class="ex-adv-block">
                                        <img src="/templates/zaimcoinsu/assets/img/icon6.png" alt="icon6.png">
