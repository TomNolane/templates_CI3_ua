        ...
        <div class="form-group has-feedback">
            ...
            <div class="col-md-8">
                <div class="ex-wrapper">
			        ...
			        data-sanitize="capitalize" data-validation="custom" data-validation-regexp="^[А-Яа-яЁёiI\-\s]+$" data-validation-error-msg="Пожалуйста, введите свою фамилию"
                    required>
                    <figure></figure>
        ...
        <div class="form-group has-feedback">
            ...
            <div class="col-md-8">
                <div class="ex-wrapper">
                    ...
                    data-validation="custom" data-validation-regexp="^[А-Яа-яЁёiI\-\s]+$" data-validation-error-msg="Пожалуйста, введите свое имя"
                    required>
        ...
        <div class="form-group has-feedback">
            ...
            <div class="col-md-8">
                <div class="ex-wrapper">
                    ...
                    data-sanitize="capitalize" data-validation="custom" data-validation-regexp="^[А-Яа-яЁёiI\-\s]+$" data-validation-error-msg="Пожалуйста, введите свое отчество"
                    required>
...
<!-- Скрываем старую форму даты рождения -->
        ...
        <div class="form-group has-feedback">
            ...
            <div class="col-md-8">
                <div class="ex-wrapper">
                    <input type="email" class="form-control ec tip special_form" name="email" id="email" title="Пожалуйста, введите свой email адрес" placeholder="Пример: email@gmail.com"
        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2 text-right"> 
                <a id="next1">
                    <button type="button" id="submitOne" class="ex-blue-btn special_forms"> Получить заём </button>
                </a> 
            </div>
        </div>
    </div>
...
<div class="ex-inf-anceta">
    <img src="/templates/zaimcoinsu/assets/img/doc.png" alt="doc.png">
