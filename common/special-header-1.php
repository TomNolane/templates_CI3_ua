<? if ($this->uri->segment(1) == 'pixell') : ?>
    ...
    <h2 class="text-center hh hh4"> Для вас подобраны организации для <span class="green_font">получения займа</span> в Украине:</h2>
<? elseif ($this->uri->segment(1) == 'offerwall') : ?>
    <style>
        .hh4 {
            font-family: Impact !important;
            font-size: 34px;
...
<? elseif ($this->uri->segment(1) == 'lk' && $this->uri->segment(1) == 'vitrina') : ?>
