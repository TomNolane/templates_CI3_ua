...
?>
<input type="hidden" name="fingerprintjs" value="" id="fingerprintjs"/><input type="hidden" name="ip" value="<?php echo $this->input->ip_address();?>" id="ip"/><input type="hidden" name="amount" value="5000" id="amount"/><input type="hidden" name="display" value="0" id="display"/><input type="hidden" name="referer" value="<?php echo getDomain($utm);?>" id="referer"/>
<script src="/templates/common/new/js/fingerprintjs2.js"></script>
<script>
new Fingerprint2().get(function (result, components) {
	document.querySelector('#fingerprintjs').value = result;
})
...
function send_stats()
{
    ...
    var _email = '', 
    _display = ((document.querySelector('#display').value == 1) ? _display = 'мобильник' : _display = 'декстоп'), 
    _fingerprint = _fingerprint = document.querySelector('#fingerprintjs').value;
