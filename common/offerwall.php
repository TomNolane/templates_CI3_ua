<?php
	...
	$description = 'Лучший онлайн сервис по выдаче мгновенных займов и кредитов без проверки вашей кредитной истории. Только у нас лучшие кредитные предложения!';
	}
	...
	$data = $this->pixelnaya->all(12, 0, '2');
	...
	<div class="container">
		<div class="row d-flex flex-row">
				...
				foreach($data as $item)
				{
						...
						?>
						<div class="col-6 col-sm-6 col-md-6 col-lg-5 mx-auto p-1 p-lg-2 col-xl-3 text-center grid_offer_item align-self-stretch">
