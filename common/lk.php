    ...
    <?php 
        ...
        foreach($data as $item)
        {
            ...
            <figure class="hh3 letsminimize">
                ...
                <div class="lk-text"><span class="start-text">Сумма</span>: до '.number_format($item['amount'],0,'',' ').'  &#8372;</div>
