<?php 
	...
	{ 
		...
		$_SESSION['standby'] = $_SESSION['standby']+1; 
		 ...
		 $ad_ddos_query = 1;// ​​number of requests per second to detect DDOS attacks
		 ...
		 //$ad_dir = __DIR__.'/anti_ddos/files';// directory with scripts
		 $ad_dir = __DIR__.'/files';// directory with scripts
		...
		<div class="loading" style="margin-top: 11%;">
		  ...
		  <div class="loading__msg"><center><b style="font-size: 22px;"><a href="https://github.com/Sanix-Darker/AntiDDOS-system" target="_blank" style="color: black;">ANTIDDOS</a> проверка....</b><br> страница покажется через несколько секунд</center></div>
		</div>
