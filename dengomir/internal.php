...
else
{
	...
	case 'zaim-card': 
		...
		$description = 'Хотите получить заем на Вашу банковскую карту в сжатые сроки?Тогда заполните несложную форму заявка на нашем онлайн-сервисе по выдаче денежных займов в Украины';
		break;
	case 'zaim-qiwi': 
	...
	case 'online-loans':
		...
		$description = 'С началом работы онлайн сервисов микрофинансовых организаций (МФО) у граждан Украины появилась
