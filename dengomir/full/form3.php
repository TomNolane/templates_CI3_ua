<section class="ex-main-form">
    <ul class="ex-tab-steps">
        ...
        <li class="ex-step-active">данные о работе</li>
        <li class="ex-step-active">Паспортные данные</li>
    </ul>
    <div class="ex-form-wrap">
        <div class="row">
            <div class="">
                <div class="form-group">
                    <label class="control-label col-md-3" for="work">Вид трудоустройства
                    </label>
                    <div class="col-md-9">
                ...
                <div class="form-group">
                    <label class="control-label col-md-3" for="work_phone">Рабочий телефон
                    </label>
                    <div class="col-md-9">
                        <div class="ex-wrapper">
                ...
                <div class="form-group">
                    <label class="control-label col-md-3" for="work_salary">Зарплата(в гривнах)
                    </label>
                    <div class="col-md-9">
                        <div class="ex-wrapper">
                ...
                <div class="form-group">
                    <label class="control-label col-md-3" for="work_city">Населённый пункт
                    </label>
                    <div class="col-md-9">
                        <div class="ex-wrapper">
                ...
                <div class="form-group">
                    <label class="control-label col-md-3" for="work_house">Номер дома
                    </label>
                    <div class="col-md-9">
                        <div class="ex-wrapper">
