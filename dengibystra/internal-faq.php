        ...
        <div class="row">
            <div class="col-sm-10 col-sm-offset-1">
                ...
                <div class="ex-faq-block">
                    ...
                    <p class="ex-text">Минимальная сумма займа 1000 гривен, максимальная сумма 100 000 гривен.
                        Минимальный срок займа 61 день, максимальный срок 1 год.</p>
                </div>
                <div class="ex-faq-block">
                ...
                <div class="ex-faq-block">
                    ...
                    <p class="ex-text">Максимальная сумма займа для новых клиентов составляет 7500 грн.
                        Для ответственных клиентов, пользующихся нашими услугами более одного раза, сумма возрастает: во
                        второй раз - до 20000 грн, с третьего раза - до 100 000 грн.</p>
                </div>
                <div class="ex-faq-block">
