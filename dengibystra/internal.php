...
switch($this->uri->segment(1))
{
    ...
    $description = 'Dengibystra осуществляет посреднические услуги между клиентом, который хочет получить деньги в заём, и кредитным учреждением, чья деятельность лицензирована';
    break;
case 'contacts': 
...
case 'soglasie': 
    ...
    $description = 'Условия получения мгновенных займов и кредитов с помощью лучшего онлайн сервиса  Dengibystra с самой низкой процентной ставкой';
    break;
case 'rules': 
    $my_title = 'Основные Правила для Предоставления Срочных Займов'; 
    $description = 'Онлайн сервис  Dengibystra предоставления срочных займов и кредитов с самой низкой процентной ставкой предоставляет условия для получения займов';
    break;
case 'credits': 
    $my_title = 'Непосильные кредиты: как не попасть в долговую яму'; 
    $description = 'К сожалению, обилие и доступность кредитных предложений на рынке Украины привело и к возникновению большого количества неплатежей.';
    break;
case 'restructuring':
...
case 'docs': 
    ...
    break;
case 'money': 
    $my_title = 'Получение денег Dengibystra'; 
...
case 'targets': 
    ...
    $description = 'Появление системы микрокредитования изначально было связано с желанием помочь бедным людям открыть свое дело. Если говорить о дне сегодняшнем, то чаще всего украинцы берут небольшие займы для иных целей. Хотя МФО и не спрашивают своих заемщиков об этих целях, общая картина у них имеется и в большинстве случаев она совпадает.';
    break;
...
case 'history-of-microloans': 
    $my_title = 'История появления микрозаймов в мире и в Украины'; 
...
case 'rate': 
    ...
    $description = 'Украинцы не снижают темпы использования кредитов: на начало 2017 г количество заемщиков составило 44,7 млн человек. Из числа работающего населения более 60% людей имеют кредиты. А каждая пятая семья вынуждена отдавать более 50% совокупного дохода на обслуживание кредитов и выплаты по ним.';
    break;
case 'errors': 
    $my_title = 'Оцените свои возможности: почему кредиты могут стать непосильными'; 
    $description = 'Украинцы не снижают темпы использования кредитов: на начало 2017 г количество заемщиков составило 44,7 млн человек. Из числа работающего населения более 60% людей имеют кредиты. А каждая пятая семья вынуждена отдавать более 50% совокупного дохода на обслуживание кредитов и выплаты по ним.';
...
case 'articles': 
    ...
    break;
default: $my_title = 'Срочные Займы Круглосуточно без Проверок Онлайн'; $description = 'Dengibystra - лучший онлайн сервис по выдаче мгновенных займов и кредитов без проверки вашей кредитной истории.Только у нас лучшие кредитные предложения!'; break;
}
