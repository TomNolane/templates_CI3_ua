            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group has-feedback">
                        ...
                        <input type="text" class="form-control ec tip" value="Завод" name="work_name" id="work_name" placeholder="Место работы" title="Укажите ваше место работы"
                ...
                <div class="col-sm-6">
                    <div class="form-group has-feedback">
                        ...
                        <input type="tel" class="form-control ec tip" name="work_phone" placeholder="Рабочий телефон" title="Введите ваш рабочий телефон"
                            id="work_phone" data-validation="custom" value="8(912)123-45-67" data-validation-regexp="^[8]\s\([0-9]{3}\)\s[0-9]{3}\s[0-9]{4}$"
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group has-feedback">
                        ...
                        <input type="tel" class="form-control ec tip" value="12" name="work_experience" id="work_experience" placeholder="Стаж работы (в месяцах)"
                ...
                <div class="col-sm-6">
                    <div class="form-group has-feedback">
                        ...
                        <input type="text" class="form-control ec tip" name="work_city" placeholder="Населённый пункт" title="Укажите населенный пункт"
                            id="work_city" value="<?php echo isset($city_name)? $city_name : 'г. Новосибирск'; ?>" data-sanitize="capitalize"
                ...
                <div class="col-sm-6">
                    <div class="form-group has-feedback">
                        ...
                        <input type="text" class="form-control ec tip" name="work_house" placeholder="№ дома" title="Укажите № дома" id="work_house"
                            data-validation="custom" value="14" data-validation-regexp="^[А-Яа-яЁё0-9\-\.\(\)\s]+$" data-validation-error-msg="Укажите № дома где работаете"
                            required>
                ...
                <div class="col-sm-6">
                    <div class="form-group has-feedback">
                        ...
                        <input type="text" class="form-control ec tip" name="work_building" placeholder="Строение/корпус" title="Укажите строение/корпус"
                            id="work_building" data-validation="custom" value="1а" data-validation-regexp="^[А-Яа-яЁё0-9\-\.\(\)\s]+$" data-validation-error-msg="Укажите строение/корпус"
                ...
                <div class="col-sm-6">
                    <div class="form-group has-feedback">
                        ...
                        <input type="text" class="form-control ec tip" name="work_office" placeholder="Офис" title="Укажите № офиса" id="work_office"
                            data-validation="custom" value="108" data-validation-regexp="^[А-Яа-яЁё0-9\-\.\(\)\s]+$" data-validation-error-msg="Укажите № офиса"
                            data-validation-optional="true">
