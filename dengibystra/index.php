        ...
        <div class="ex-calc-wraper">
            ...
            <div class="ex-range-scope">
                ...
                <?php if (!empty($_REQUEST['ad_id'])) echo '<input type="hidden" name="ad_id" value="'.$_REQUEST['ad_id'].'">'; ?> 
                    <input type="hidden" class="amount" id="amount" name="amount" value="600" />
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="ex-info-block hidden-xs hidden-sm">
                    ...
                    <p>Если вы взяли займ на сумму 50 000 гривен на 6 месяцев с процентной ставкой 4,5% в месяц, то после истечения
                        срока займа переплата составит 13500 гривен. Получается вы возвращаете 63 500 гривен. Ниже приведены
                    ...
                    <p class="ex-hidden">
                        Сумма - 50 000 гривен, процент в месяц - 4,5%, срок займа - 6 месяца. 4,5(%) * 6(мес) = 27% за 6 месяцев(27% * 50 000грн
                        (сумма займа) )/100% = 13 500 гривен (сумма начисленных процентов) 50 000 + 13 500 = 63 500 гривен
